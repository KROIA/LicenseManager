...
#include "LicenseManager_debug.h"
#include "LicenseManager_meta.h"
...
/// USER_SECTION_END
	...
	public:
		...
		static constexpr int versionMajor				= LicenseManager_VERSION_MAJOR;
		static constexpr int versionMinor				= LicenseManager_VERSION_MINOR;
		static constexpr int versionPatch				= LicenseManager_VERSION_PATCH;
		...
		static constexpr const char* name				= LicenseManager_LIBRARY_NAME;
